...
#
# Script Description:
# read process pediatric dcm samples
...
#Read10X("data/pediatric_DCM/GSM5606406_DCM1_processed.tar.gz", )

# Set the path to the current directory
current_dir <- "data/pediatric_DCM/extracted"

# Get a list of directories in the current directory
directories <- list.dirs(path = current_dir, full.names = TRUE)
...
samples= list.files(current_dir)
...
for (i in 1:length(sample_names)){
  ...
  assign(sample_names[i], Read10X(paths[i]))
}
# 
# # test vars:
# input_data= ct1
...
process_data= function(sample_name, input_data,
  ...
  saveRDS(sample_seurat, file = paste0("data/pediatric_DCM/custom_processed/", sample_name, ".rds"))
  
  # Plot QC files
  
  pdf(file = paste0("data/pediatric_DCM/custom_processed/", sample_name, ".pdf"), width = 8, height = 8)
...
process_data(sample_name = "GSM5606406_DCM_1",input_data =  GSM5606406)
process_data(sample_name = "GSM5606407_DCM_2",input_data =  GSM5606407)
process_data(sample_name = "GSM5606408_DCM_3",input_data =  GSM5606408)
process_data(sample_name = "GSM5606409_DCM_4",input_data =  GSM5606409)

process_data(sample_name = "GSM5606410_FET_1",input_data =  GSM5606410)
process_data(sample_name = "GSM5606411_FET_2",input_data =  GSM5606411)
process_data(sample_name = "GSM5606412_FET_3",input_data =  GSM5606412)

process_data(sample_name = "GSM5606413_YOUNG_1",input_data =  GSM5606413)
process_data(sample_name = "GSM5606414_YOUNG_2",input_data =  GSM5606414)
process_data(sample_name = "GSM5606415_YOUNG_3",input_data =  GSM5606415)
