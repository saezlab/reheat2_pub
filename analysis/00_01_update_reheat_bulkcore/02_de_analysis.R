...
source("~/R-projects/HF_meta-analysis/src/data_utils.R")
source("~/R-projects/HF_meta-analysis/src/misc_utils.R")

METAheart = readRDS(file = "output/reheat1/METAheart2023_1.rds") #main object
names(METAheart) = str_replace_all(names(METAheart), pattern = "-", ".")
...
saveRDS(covariate_summary, file = "output/reheat1/covariate_summary.rds")
...
HF_mat = METAheart$Greco12$GEX
targets = METAheart$Greco12$TARGETS
...
METAheart$Greco12[["HF_limma"]] = HF_results_adj
...
HF_mat = METAheart$vanHeesch19$GEX
targets = METAheart$vanHeesch19$TARGETS
...
METAheart$vanHeesch19[["HF_limma"]] = HF_results_adj
...
saveRDS(METAheart, file = "output/reheat1/METAheart2023.rds")
